  ...
  return (
    <div className="bg-[#EEEEEE] my-10 p-5 pt-10 md:p-10 md:py-20">
      <div>
        ...
        <p className=" text-secondaryText text-sm md:text-base md:w-8/12 lg:w-6/12 text-center mx-auto mt-5 md:mt-8">
      ...
      <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:px-6 xl:px-44 mt-12 rounded-md">
        <div className=" bg-white p-3 md:p-6 rounded-lg flex flex-col items-center shadow-md hover:-translate-y-1 hover:scale-105 duration-200 transition-all cursor-pointer">
