...
const FeatureDetails = () => {
  return (
    <div className=" my-12">
      <h2 className=" text-primaryText font-semibold text-xl md:text-3xl text-center mt-4">
        Effortlessly Design, Customize, and Export Forms in Minutes.
      </h2>
      <p className=" text-secondaryText md:w-6/12 mx-auto text-center mt-8 p-3">
      ...
      <div className=" grid grid-cols-1 md:grid-cols-2 md:gap-20 lg:gap-40 mt-10 md:mt-3">
        <div className=" w-full h-full flex justify-end items-center">
          <div className=" md:w-8/12 lg:w-6/12 p-3 md:p-0">
            ...
            <p className=" text-secondaryText mt-2">
              ...
              view how your form will look and function as you build it.
            </p>
          </div>
        </div>
        <div className=" max-w-[500px] max-h-[500px] mx-auto md:mx-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 md:gap-20 lg:gap-40 mt-3 md:mt-0">
        <div className="flex md:justify-end justify-start order-2 md:order-1">
          <div className="max-w-[450px] max-h-[450px] mx-auto md:mx-0">
        ...
        <div className="w-full h-full flex md:justify-start justify-center items-center order-1 md:order-2">
          <div className="md:w-10/12 lg:w-6/12 p-3 md:p-0">
            <h3 className="text-primaryText font-semibold text-2xl inline-block">
              Exportable Code For React/Next{" "}
            </h3>
            <p className="text-secondaryText mt-2">
              Easily integrate your form into a larger project. export your form
              as clean, well-documented code for React and Next.js. and Jump
              start your development process with a dynamic form boilerplate
            </p>
          </div>
        </div>
      </div>
