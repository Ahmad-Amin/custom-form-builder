...
import OfficeWorkingAnimation from "../animations/office-working.json";
              ...
              <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form className="space-y-4 md:space-y-6" action="#">
                  ...
                  <button
                    ...
                    className="w-full bg-[#0E8388] hover:bg-[#246c6e] text-white focus:ring-4 focus:outline-none font-medium rounded-lg text-base px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                  >
                    Create New account
                  </button>
                  <p className="text-sm">
